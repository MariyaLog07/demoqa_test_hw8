...
static void beforeAll() {
    ...
    void fillPracticeFormTest(){
        ...
        $(".table-responsive").shouldHave(text("Mariya Logutenko"),text("Test@gmail.com"),text("Female"),text("8900369852"),text("25 August,2020"),text("Maths"),text("Sports"),text("1.png"),text("Lermontova street,1"),text("NCR Delhi" ));
    }
